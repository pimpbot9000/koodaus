...
###  1.1
Muokkaa ohjelmaa siten että se etsii listan pienimmän luvun. Ensimmäisenä tietysti nimetään muuttuja `max_value` uudestaan (`min_value`). Pohdi tarkkaan mikä
nyt asetetaan muuttujan `min_value` alkuperäiseksi arvoksi.
</Segment>
...
<Obs>Ole tarkka if-elif-else-järjestyksen kanssa.</Obs>
