...
const IndexPage = () => {
  return (
    <Layout pageTitle="Coding 101 for children (and slow adults!)">
      ...
      <p>Opiskeluvinkki. Kun törmäät koodiesimerkkiin toimi seuraavasti:</p>
      <ul>
        <li>Ensiksi tutkaile koodia ja pohdi mitä se kenties tekee</li>
        <li>Kun olet saanut jonkinlaisen perstuntuman koodiin, suorita koodi (painamalla "play" nappulaa) ja katso toimiiko se niinkuin ajattelit sen toimivan.</li>
      </ul>
