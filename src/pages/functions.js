    ...
    return <Layout pageTitle="Funktiot">
        ...
        <Segment title="1. Eka funktio">
            ...
            <Obs>Virallinen termi ulos pullauttamiselle on "palauttaa arvo", tästä syystä
                Pythonissa on <code>return</code> käsky.</Obs>
        ...
        <Segment title="2. Funktion ei tarvitse palauttaa mitään">
            <p>Matematiikassa funktio palauttaa aina jonkin arvon. Ohjelmointikielissä voidaan myös laatia funktioita, jotka eivät palauta mitään arvoja.
                 Alla on esimerkki tällaisesta funktiosta:
            ...
            <Obs>Python-ohjelmointikielellä laaditun funktion ei välttämättä tarvitse palauttaa mitään arvoa, joten kaikki Python-kielellä laaditut funktiot eivät ole funktioita samassa mielessä kuin
                matematiikassa.
            </Obs>
            <h4>Tehtävä 2.1</h4>
