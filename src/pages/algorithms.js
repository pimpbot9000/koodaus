...
const MathPage = () => {
    return <Layout pageTitle="Algoritmit">
        ...
        <Segment title="2. Listan lukujen summa">
            ...
            <h5>Tehtävä 2.3</h5>
            <p>Tee sovellus, joka laskuu lukujen 1, 2, 3, 4, ... , <code>n</code> tulon, jossa <code>n</code> on käyttäjän syöttämä luku. Käytä <code>for</code>-simulkkaa
            ja <code>range</code>-funktiota.</p>
            <Obs>
                <p>Tämän kaltainen laskutoimitus on kenties sinulle tuttu, jos olet matematiikan tunnilla laskenut kombinaatioiden lukumääriä.</p>
            </Obs>
